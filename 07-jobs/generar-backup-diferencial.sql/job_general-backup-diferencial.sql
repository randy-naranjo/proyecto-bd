...
-- Agregar un schedule para las 9am
EXEC msdb.dbo.sp_add_jobschedule 
    @job_name = N'GenerarBackupDiferencialCada3horas',
...
-- Agregar un schedule para las 12pm
EXEC msdb.dbo.sp_add_jobschedule 
    @job_name = N'GenerarBackupDiferencialCada3horas',
...
-- Agregar un schedule para las 3pm
EXEC msdb.dbo.sp_add_jobschedule 
    @job_name = N'GenerarBackupDiferencialCada3horas',
...
-- Agregar un schedule para las 6pm
EXEC msdb.dbo.sp_add_jobschedule 
    @job_name = N'GenerarBackupDiferencialCada3horas',
...
-- Agregar un schedule para las 9pm
EXEC msdb.dbo.sp_add_jobschedule 
    @job_name = N'GenerarBackupDiferencialCada3horas',
